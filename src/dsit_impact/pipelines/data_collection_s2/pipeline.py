    ...
    return pipeline(
        [
            node(
                ...
                inputs={
                    "oa_dataset": "oa.publications.gtr.primary.december",
                ...
                outputs="s2.citation_details.raw.december",
            ...
            node(
                ...
                outputs="s2.paper_details.raw.december",
                name="get_s2_paper_data",
            ),
            node(
                func=concatenate_partitions,
                inputs={"partitioned_dataset": "s2.citation_details.raw.december"},
                outputs="s2.citation_details.intermediate.december",
                name="concatenate_citation_partitions",
            ),
            node(
                func=concatenate_partitions,
                inputs={"partitioned_dataset": "s2.paper_details.raw.december"},
                outputs="s2.paper_details.intermediate.december",
