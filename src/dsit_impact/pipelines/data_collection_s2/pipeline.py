        ...
        [
            node(
                ...
                inputs={
                    ...
                    "filter_date": "params:s2.data_collection.filter_date",  # set to None, "2022-01-01" used for dec24 update
                },
                outputs="s2.citation_details.raw",  # for dec24 update, use catalog entry "s2.citation_details.dec24"
            ...
            node(
                ...
                outputs="s2.paper_details.raw",  # for dec24 update, use catalog entry "s2.paper_details.dec24"
